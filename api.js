...
const mongourl = `mongodb+srv://admin:mongo@123@cluster0.f8vmc.mongodb.net/livemongo?retryWrites=true&w=majority`;
let db;
let col_name="mongoaltas";
